...
import { CreateGame } from "./PlayWithFriends";
import { JoinRandomGame } from "./PlayWithRandom";
...
export function JoinGameCard() {
  const [activeTab, setActiveTab] = useState<"join-random-game" | "create-game">(
    "join-random-game",
  );
      ...
      <CardContent className="w-full">
        <div className="border-b pt-6">
          <div className="flex gap-2">
            <Button
              type="button"
              className={activeTab === "join-random-game" ? activeButtonStyle : inactiveButtonStyle}
            ...
            <Button
              type="button"
              className={activeTab === "create-game" ? activeButtonStyle : inactiveButtonStyle}
