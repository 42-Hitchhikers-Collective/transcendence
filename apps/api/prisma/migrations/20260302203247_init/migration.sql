...
-- CreateEnum
CREATE TYPE "GameStatus" AS ENUM ('RUNNING', 'FINISHED', 'ABORTED');

-- CreateEnum
CREATE TYPE "ConversationType" AS ENUM ('DM', 'LOBBY', 'GAME');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('FRIEND_REQUEST', 'INVITE', 'GAME_RESULT', 'SYSTEM');
...
-- CreateIndex
CREATE INDEX "Invite_lobbyId_idx" ON "Invite"("lobbyId");
...
-- AddForeignKey
ALTER TABLE "Invite" ADD CONSTRAINT "Invite_lobbyId_fkey" FOREIGN KEY ("lobbyId") REFERENCES "Lobby"("id") ON DELETE CASCADE ON UPDATE CASCADE;
